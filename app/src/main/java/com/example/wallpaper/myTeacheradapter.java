...
public class myTeacheradapter extends FirebaseRecyclerAdapter<Teacher, myTeacheradapter.myTeacherviewHolder> {
    Context context;

    public myTeacheradapter(@NonNull FirebaseRecyclerOptions<Teacher> options, Context context) {
        super(options);
        this.context=context;
    }

    @Override
    protected void onBindViewHolder(@NonNull final myTeacherviewHolder holder, int position, @NonNull final Teacher model) {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        switch (item.getItemId()) {
                            ...
                            case R.id.delete_btn_rec:
                                DatabaseReference reference= FirebaseDatabase.getInstance().getReference("teacher").child(model.getId());
    ...
    @NonNull
    @Override
    public myTeacherviewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_user, parent, false);

        return new myTeacherviewHolder(view);
    }


    class myTeacherviewHolder extends RecyclerView.ViewHolder {
